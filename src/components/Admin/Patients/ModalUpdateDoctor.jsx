...
import { useAdminGetOneDoctorQuery, useAdminGetOnePatientQuery, useAdminUpdateDoctorMutation, useAdminUpdatePatientMutation } from '../../../redux/api/adminApi';
...
function ModalUpdateDoctor(props) {
    ...
    const [update, { isLoading, isError, isSuccess, error }] = useAdminUpdatePatientMutation();
    ...
    return (
        <Modal show={show} onHide={handleClose} backdrop='static' keyboard={false}>
            <Modal.Header closeButton>
                <Modal.Title>Cập nhật bệnh nhân: {formData.name}</Modal.Title>
            </Modal.Header>
            <Modal.Body>
